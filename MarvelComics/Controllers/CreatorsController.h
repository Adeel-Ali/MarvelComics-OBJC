...
typedef void (^CompletedGetComicsCollectionByCreatorId)(BOOL success, HttpContext* context, ComicDataWrapper* response, NSError* error);
...
*/
- (void) getComicsCollectionByCreatorIdAsyncWithCreatorId:(NSString*) creatorId
                ...
                upc:(NSString*) upc
                completionBlock:(CompletedGetComicsCollectionByCreatorId) onCompleted;

/**
* Completion block definition for asynchronous call to getCreatorEventsCollection */
typedef void (^CompletedGetCreatorEventsCollection)(BOOL success, HttpContext* context, EventDataWrapper* response, NSError* error);
...
*/
- (void) getCreatorEventsCollectionAsyncWithCreatorId:(NSString*) creatorId
                characters:(NSString*) characters
                ...
                series:(NSString*) series
                stories:(NSString*) stories
                completionBlock:(CompletedGetCreatorEventsCollection) onCompleted;

/**
* Completion block definition for asynchronous call to getCreatorSeriesCollection */
typedef void (^CompletedGetCreatorSeriesCollection)(BOOL success, HttpContext* context, SeriesDataWrapper* response, NSError* error);
...
*/
- (void) getCreatorSeriesCollectionAsyncWithCreatorId:(NSString*) creatorId
                characters:(NSString*) characters
                comics:(NSString*) comics
                ...
                title:(NSString*) title
                titleStartsWith:(NSString*) titleStartsWith
                completionBlock:(CompletedGetCreatorSeriesCollection) onCompleted;

/**
* Completion block definition for asynchronous call to getCreatorStoryCollection */
typedef void (^CompletedGetCreatorStoryCollection)(BOOL success, HttpContext* context, StoryDataWrapper* response, NSError* error);
...
*/
- (void) getCreatorStoryCollectionAsyncWithCreatorId:(NSString*) creatorId
                characters:(NSString*) characters
                comics:(NSString*) comics
                events:(NSString*) events
                limit:(NSString*) limit
...
typedef void (^CompletedGetCreatorCollection)(BOOL success, HttpContext* context, CreatorDataWrapper* response, NSError* error);
...
*/
- (void) getCreatorCollectionAsyncWithComics:(NSString*) comics
                events:(NSString*) events
                ...
                completionBlock:(CompletedGetCreatorCollection) onCompleted;
