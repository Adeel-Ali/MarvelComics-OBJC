                ...
                completionBlock:(CompletedGetComicsCharacterCollection) onCompleted
{
    ...
    [_queryBuilder appendString: @"/characters/{characterId}/comics"];
                ...
                completionBlock:(CompletedGetCharacterEventsCollection) onCompleted
{
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/characters/{characterId}/events"];
                ...
                completionBlock:(CompletedGetCharacterSeriesCollection) onCompleted
{
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/characters/{characterId}/series"];
                ...
                completionBlock:(CompletedGetCharacterStoryCollection) onCompleted
{
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/characters/{characterId}/stories"];
                ...
                completionBlock:(CompletedGetCharacterIndividual) onCompleted
{
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/characters/{characterId}"];
    ...
    [[self clientInstance]
     ...
     success: ^(id _context, HttpResponse *_response) {
         ...
         if (_response.statusCode == 404)
             _statusError = [[APIError alloc] initWithReason: @"Character not found."
                                                    andCode: _response.statusCode
                                                    andData: _response.rawBody];
         ...
         else
         {
             //return _response to API caller
             NSString* _strResult = [(HttpStringResponse*)_response body];
             Character* _result = (Character*) [APIHelper jsonDeserialize: _strResult
                ...
                completionBlock:(CompletedGetCharacterCollection) onCompleted
{
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/characters"];
