                ...
                completionBlock:(CompletedGetSeriesIndividual) onCompleted
{
    ...
    [_queryBuilder appendString: @"/series/{seriesId}"];
    ...
    [[self clientInstance]
     ...
     success: ^(id _context, HttpResponse *_response) {
         ...
         if (_response.statusCode == 404)
             _statusError = [[APIError alloc] initWithReason: @"Series not found."
         ...
         else
         {
             ...
             Series* _result = (Series*) [APIHelper jsonDeserialize: _strResult
                toClass: Series.class];
                ...
                completionBlock:(CompletedGetSeriesCharacterWrapper) onCompleted
{
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/series/{seriesId}/characters"];
                ...
                completionBlock:(CompletedGetComicsCollectionBySeriesId) onCompleted
{
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/series/{seriesId}/comics"];
                ...
                completionBlock:(CompletedGetCreatorCollectionBySeriesId) onCompleted
{
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/series/{seriesId}/creators"];
                ...
                completionBlock:(CompletedGetEventsCollectionBySeriesId) onCompleted
{
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/series/{seriesId}/events"];
                ...
                completionBlock:(CompletedGetSeriesStoryCollection) onCompleted
{
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/series/{seriesId}/stories"];
                ...
                completionBlock:(CompletedGetSeriesCollection) onCompleted
{
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/series"];
