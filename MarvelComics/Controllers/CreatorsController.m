                ...
                completionBlock:(CompletedGetComicsCollectionByCreatorId) onCompleted
{
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/creators/{creatorId}/comics"];
                ...
                completionBlock:(CompletedGetCreatorEventsCollection) onCompleted
{
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/creators/{creatorId}/events"];
                ...
                completionBlock:(CompletedGetCreatorSeriesCollection) onCompleted
{
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/creators/{creatorId}/series"];
                ...
                completionBlock:(CompletedGetCreatorStoryCollection) onCompleted
{
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/creators/{creatorId}/stories"];
                ...
                completionBlock:(CompletedGetCreatorCollection) onCompleted
{
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/creators"];
