...
typedef void (^CompletedGetEventCharacterCollection)(BOOL success, HttpContext* context, CharacterDataWrapper* response, NSError* error);
...
*/
- (void) getEventCharacterCollectionAsyncWithEventId:(NSString*) eventId
                ...
                completionBlock:(CompletedGetEventCharacterCollection) onCompleted;

/**
* Completion block definition for asynchronous call to getComicsCollectionByEventId */
typedef void (^CompletedGetComicsCollectionByEventId)(BOOL success, HttpContext* context, ComicDataWrapper* response, NSError* error);
...
*/
- (void) getComicsCollectionByEventIdAsyncWithEventId:(NSString*) eventId
                ...
                upc:(NSString*) upc
                completionBlock:(CompletedGetComicsCollectionByEventId) onCompleted;

/**
* Completion block definition for asynchronous call to getCreatorCollectionByEventId */
typedef void (^CompletedGetCreatorCollectionByEventId)(BOOL success, HttpContext* context, CreatorDataWrapper* response, NSError* error);
...
*/
- (void) getCreatorCollectionByEventIdAsyncWithEventId:(NSString*) eventId
                comics:(NSString*) comics
                ...
                completionBlock:(CompletedGetCreatorCollectionByEventId) onCompleted;

/**
* Completion block definition for asynchronous call to getEventSeriesCollection */
typedef void (^CompletedGetEventSeriesCollection)(BOOL success, HttpContext* context, SeriesDataWrapper* response, NSError* error);
...
*/
- (void) getEventSeriesCollectionAsyncWithEventId:(NSString*) eventId
                characters:(NSString*) characters
                comics:(NSString*) comics
                ...
                title:(NSString*) title
                titleStartsWith:(NSString*) titleStartsWith
                completionBlock:(CompletedGetEventSeriesCollection) onCompleted;

/**
* Completion block definition for asynchronous call to getEventStoryCollection */
typedef void (^CompletedGetEventStoryCollection)(BOOL success, HttpContext* context, StoryDataWrapper* response, NSError* error);
...
*/
- (void) getEventStoryCollectionAsyncWithEventId:(NSString*) eventId
                characters:(NSString*) characters
                comics:(NSString*) comics
                creators:(NSString*) creators
                limit:(NSString*) limit
...
typedef void (^CompletedGetEventsCollection)(BOOL success, HttpContext* context, EventDataWrapper* response, NSError* error);
...
*/
- (void) getEventsCollectionAsyncWithCharacters:(NSString*) characters
                comics:(NSString*) comics
                creators:(NSString*) creators
                limit:(NSString*) limit
                modifiedSince:(NSString*) modifiedSince
                ...
                series:(NSString*) series
                stories:(NSString*) stories
                completionBlock:(CompletedGetEventsCollection) onCompleted;
