                ...
                completionBlock:(CompletedGetEventCharacterCollection) onCompleted
{
    ...
    [_queryBuilder appendString: @"/events/{eventId}/characters"];
                ...
                completionBlock:(CompletedGetComicsCollectionByEventId) onCompleted
{
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/events/{eventId}/comics"];
                ...
                completionBlock:(CompletedGetCreatorCollectionByEventId) onCompleted
{
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/events/{eventId}/creators"];
                ...
                completionBlock:(CompletedGetEventSeriesCollection) onCompleted
{
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/events/{eventId}/series"];
                ...
                completionBlock:(CompletedGetEventStoryCollection) onCompleted
{
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/events/{eventId}/stories"];
                ...
                completionBlock:(CompletedGetEventIndividual) onCompleted
{
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/events/{eventId}"];
    ...
    [[self clientInstance]
     ...
     success: ^(id _context, HttpResponse *_response) {
         ...
         if (_response.statusCode == 404)
             _statusError = [[APIError alloc] initWithReason: @"Event not found."
                                                    andCode: _response.statusCode
                                                    andData: _response.rawBody];
         ...
         else
         {
             //return _response to API caller
             NSString* _strResult = [(HttpStringResponse*)_response body];
             Event* _result = (Event*) [APIHelper jsonDeserialize: _strResult
                toClass: Event.class];
