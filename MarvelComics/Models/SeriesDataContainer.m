...
@implementation SeriesDataContainer
...
/**
 * For deserialization of enum Series type property from NSArray
 */
 -(void)setResultsWithNSArray:(NSArray*) array
{
	NSError* err;
    results = [Series arrayOfModelsFromDictionaries:array error:&err];
	if(err){
