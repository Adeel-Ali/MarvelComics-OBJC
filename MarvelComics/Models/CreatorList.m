...
/**
 * For deserialization of enum CreatorSummary type property from NSArray
 */
 -(void)setItemsWithNSArray:(NSArray*) array
{
	NSError* err;
    items = [CreatorSummary arrayOfModelsFromDictionaries:array error:&err];
	if(err){
