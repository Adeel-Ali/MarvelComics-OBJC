...
/**
 * For deserialization of enum Story type property from NSArray
 */
 -(void)setResultsWithNSArray:(NSArray*) array
{
	NSError* err;
    results = [Story arrayOfModelsFromDictionaries:array error:&err];
	if(err){
