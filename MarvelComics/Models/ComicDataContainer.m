...
/**
 * For deserialization of enum Comic type property from NSArray
 */
 -(void)setResultsWithNSArray:(NSArray*) array
{
	NSError* err;
    results = [Comic arrayOfModelsFromDictionaries:array error:&err];
	if(err){
