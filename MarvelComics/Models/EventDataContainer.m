...
/**
 * For deserialization of enum Event type property from NSArray
 */
 -(void)setResultsWithNSArray:(NSArray*) array
{
	NSError* err;
    results = [Event arrayOfModelsFromDictionaries:array error:&err];
	if(err){
