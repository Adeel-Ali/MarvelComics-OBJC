...
The following instructions help you integrate with an existing CocoaPods project.
    ...
    1. Create a folder named MarvelComics in /path/to/your/project/Vendor/
    2. Extract the contents of the SDK in to the folder named MarvelComics
    3. Add the following line to your PodFile : 
           pod 'MarvelComics', :path => 'Vendor/MarvelComics'
...
the following.
    ...
    3. A new file named "MarvelComics.xcworkspace" will be created as a result.
    4. Open the "MarvelComics.xcworkspace" in XCode 5.0.
